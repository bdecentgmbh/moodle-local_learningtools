...
$string['autosavenotes'] = 'Auto-save notes';
$string['autosavenotes_desc'] = 'When enabled, notes taken in the Learning Tools drawer are saved automatically when you leave the editor or close the drawer, so no Save button is needed.';
...
$string['buttonposition'] = 'Learning Tools button position';
$string['buttonposition:bottomleft'] = 'Floating button (bottom left)';
$string['buttonposition:bottomright'] = 'Floating button (bottom right)';
$string['buttonposition:drawer'] = 'Navbar icon with drawer';
$string['buttonposition_desc'] = 'Choose where the Learning Tools launcher appears: a floating button in the bottom-right or bottom-left corner, or an icon in the navbar that opens the tools in a drawer.';
...
$string['learningtoolsdrawer'] = 'Learning Tools';
...
$string['noactivity'] = "No force activity";
$string['none'] = "None";
...
$string['today'] = "Today";
$string['togglelearningtools'] = 'Toggle Learning Tools';
