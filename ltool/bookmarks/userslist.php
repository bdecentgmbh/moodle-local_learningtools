...
/**
 * List of the students to view bookmarks.
 *
...
$participanttable = new \local_learningtools\table\courseparticipants
("user-index-participants-bookmarks", $bookmarkslisturl->out(false));
$participanttable->define_baseurl($CFG->wwwroot.'/local/learningtools/ltool/bookmarks/userslist.php');
